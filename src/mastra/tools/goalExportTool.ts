  ...
  execute: async ({ context }) => {
    ...
    switch (format) {
      case ExportFormat.JSON:
        ...
        filename = `legianos-goals-${new Date().toISOString().split('T')[0]}.json`
      ...
      case ExportFormat.MARKDOWN:
        ...
        filename = `legianos-goals-${new Date().toISOString().split('T')[0]}.md`
      ...
      case ExportFormat.CSV:
        ...
        filename = `legianos-goals-${new Date().toISOString().split('T')[0]}.csv`
        mimeType = 'text/csv'
        break
      ...
      case ExportFormat.PDF:
        ...
        filename = `legianos-goals-${new Date().toISOString().split('T')[0]}.html`
        mimeType = 'text/html'
        break
...
function generateMarkdownExport(goals: Goal[], options: any): string {
  ...
  const subtitle = customization?.subtitle || `Generated by LegianOS Goal Management System`
  ...
  // Footer
  content += `\n---\n\n`
  content += `*Generated by [LegianOS Goal Management System](https://github.com/legianos) on ${new Date(exportDate).toLocaleDateString()}*\n`
...
<body>
    <div class="header">
        ...
        <p>${customization?.subtitle || "Generated by LegianOS Goal Management System"}</p>
...
`
  ...
  html += `
    <div class="footer">
        <p>Generated by <strong>LegianOS Goal Management System</strong></p>
